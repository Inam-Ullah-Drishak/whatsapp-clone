    ...
    >
      ...
      >
        <div className="flex items-start justify-between border-b border-neutral-100 p-6 pb-4">
          <div>
            <h2 className="text-lg font-medium text-neutral-900">Starred messages</h2>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-3">
          ...
          <div className="space-y-2">
            {messages.map((m) => (
              <div
                key={m._id}
                className="rounded-lg border border-neutral-100 p-3 hover:bg-neutral-50"
              >
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="shrink-0 px-2 text-xs text-neutral-500 hover:text-amber-600"
                  >
                    Unstar
                  </button>
                </div>
