    ...
    >
      ...
      >
        <div className="flex items-start justify-between">
          <div>
            <h2 className="text-lg font-medium text-neutral-900">New chat</h2>
        ...
        {result && (
          <button
            onClick={startChat}
            disabled={busy}
            className="mt-5 flex w-full items-center gap-3 rounded-lg border border-neutral-200 p-3 text-left transition hover:bg-neutral-50 disabled:opacity-50"
          >
            <Avatar
            ...
            <div className="min-w-0">
              ...
              <p className="truncate text-sm text-neutral-500">{result.about}</p>
            </div>
          </button>
        )}
      </div>
